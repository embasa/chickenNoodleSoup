...
public class TreePrinter {
    ...
    public TreePrinter(BinarySearchTree<Integer> tree) {
        this.tree = tree;
        this.height = tree.getRootHeight();
    }

    public void setTree(BinarySearchTree<Integer> tree) {
        this.tree = tree;
    }
    ...
    public void print(String label) {
        ...
        BinarySearchTree.BinaryNode<Integer> thisLevelNodes[] =
                (BinarySearchTree.BinaryNode<Integer>[]) new BinarySearchTree.BinaryNode[1];
        ...
        for (int level = 0; level <= height; level++) {
            ...
            if (level != height) {
                ...
                // Print outgoing pointeers /\ from each parent node.
    ...
    private void printData(int level, int offset,
        ...
        for (int i = 0; i < k; i++) {
            BinarySearchTree.BinaryNode<Integer> node = levelNodes[i];

            if (node != null) {
                System.out.printf("%3d ", node.getElement());
            } else {
                System.out.print("    ");
            }
    ...
    private BinarySearchTree.BinaryNode<Integer>[] nextLevel(int level,
        ...
        BinarySearchTree.BinaryNode<Integer> nextLevel[] =
                (BinarySearchTree.BinaryNode<Integer>[]) new BinarySearchTree.BinaryNode[POWERS_OF_2[level + 1]];
