...
public class Main {
    ...
    /**
     * Compares an AVL and BST tree for insertion time of N elements,
     * for access time of those elements. And finally test performance
     * when using M series of insertions.
     */
