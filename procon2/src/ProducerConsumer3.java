...
public class ProducerConsumer3 
{
    ...
    public ProducerConsumer3(int producerCount, int consumerCount)
    {
    ...
    public static void main(String[] args) 
    {
        ...
        (new ProducerConsumer3(producerCount, consumerCount)).test();
    }
    ...
    public class Consumer extends Thread
    {
        ...
        {
            int maxItems = producerCount*MAX_PRODUCTION;
