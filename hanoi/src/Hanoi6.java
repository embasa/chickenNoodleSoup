 ...
 * against solving it nonrecursively using a custom Stack class.
 * 
 * CS 146
 * Summer 2015
...
public class Hanoi6
{
    ...
    /**
     * A custom stack class built from a simple array of Parms.
     */
    private class Stack
    {         
    ...
    {
        System.out.printf("\nSolve nonrecursively with custom stack for %d disks:\n", n);
        stack = new Stack((int) Math.pow(2, n));
